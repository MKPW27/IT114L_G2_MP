...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="booking-con">
        ...
        <div class="container">
            <div class="booking-input-container">
                <div class="booking-input">
                    <p>Lights and Sounds Package</p>
                    <asp:TextBox ID="package" runat="server" CssClass="input"></asp:TextBox>
                </div>
                <div class="booking-input">
                    <p>Package Type</p>
                    <asp:TextBox ID="packageType" runat="server" CssClass="input"></asp:TextBox>
                </div>
            </div>
            <div class ="booking-input">
            <p>Specific Service Options:</p>
            <asp:CheckBoxList ID="specificService" runat="server" CssClass="checkbox">
                <asp:ListItem Text="Backline (Band Setup)" Value="1"></asp:ListItem>
                <asp:ListItem Text="Stage" Value="2"></asp:ListItem>
                <asp:ListItem Text="Roofing" Value="3"></asp:ListItem>
                <asp:ListItem Text="LED Wall" Value="4"></asp:ListItem>
                <asp:ListItem Text="DJ" Value="5"></asp:ListItem>
            </asp:CheckBoxList>
